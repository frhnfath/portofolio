            ...
            className="mb-8 flex flex-wrap lg:justify-center" key={index}>
                ...
                className="w-full lg:w-1/4">
                    <div className="grid grid-cols-2 gap-2">
                        <img className="mb-6 rounded" src={project.image1} width={150} height={150} alt={project.title} />
                        <img className="mb-6 rounded" src={project.image2} width={150} height={150} alt={project.title} />
                    </div>
